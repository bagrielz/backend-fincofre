...
public record SpentDetailsDTO(Long id, Long userId, String date, String spent, Status status, String value, Category category, SpentType type, String account, Method method) {
